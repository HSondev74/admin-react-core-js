...
/**
 * Extended CustomDataTable with additional "Add Child" action for menu management
 */
const MenuDataTable = ({
  data = [],
  columns = [],
      ...
      <Box sx={tableStyles.actionButtonStyle}>
        ...
        >
          ...
          {onAddChild && (
            ...
            >
              <PlusOutlined style={{ ...tableStyles.menuItemIcon, marginRight: 8 }} /> Thêm con
            </MenuItem>
          )}
...
MenuDataTable.propTypes = {
  ...
  onAddChild: PropTypes.func, // New prop
